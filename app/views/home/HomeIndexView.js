			...
			items: [
				{
			        ...
			        tpl: '<tpl for="."><div class="stockInfoItem" style="font-size: 0.8em;"><h1 style="font-weight: bold; font-size: 120%;">{name}</h1><div class="stockInfoLeft">Open: {openPrice}<br />High: {highPrice}<br />Low: {lowPrice}<br />Vol: {volume}<br />P/E: {peRatio}</div><div class="stockInfoRight">Mkt Cap: {marketCap}<br />52w High: {wkHigh}<br />52w Low: {wkLow}<br />Avg Vol: {avgVolume}<br />Yield: {yield}</div></div></tpl>',
					listeners: {
